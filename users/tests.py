...
class UserTestCase(APITestCase):
    ...
    def test_create_user(self):
        response = self.client.post(reverse_lazy('users:user-list'), data=self.user_data)
    ...
    def test_unique_username(self):
        response = self.client.post(reverse_lazy('users:user-list'), data={**self.user_data, 'username': 'custom'})
    ...
    def test_rejected_weak_password(self):
        response = self.client.post(reverse_lazy('users:user-list'), data={**self.user_data, 'password': 'password'})
    ...
    def test_only_admin_list_retrieve_users(self):
        ...
        response = self.client.get(reverse_lazy('users:user-detail', kwargs={'pk': self.admin_user.pk}))
    ...
    def test_only_admin_or_owner_can_retrieve_user(self):
        response = self.client.get(reverse_lazy('users:user-detail', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_only_owner_can_update_his_profile(self):
        response = self.client.patch(reverse_lazy('users:user-detail', kwargs={'pk': self.custom_user.pk}),
                                     data={'username': 'new'})
    ...
    def test_admin_can_ban_user(self):
        ...
        response = self.client.post(reverse_lazy('users:user-ban', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_admin_can_unban_user(self):
        ...
        response = self.client.delete(reverse_lazy('users:user-ban', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_admin_can_promote_user(self):
        ...
        response = self.client.post(reverse_lazy('users:user-promote', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_admin_can_demote_user(self):
        ...
        response = self.client.delete(reverse_lazy('users:user-promote', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_user_can_change_password(self):
        ...
        response = self.client.post(reverse_lazy('users:user-change-password', kwargs={'pk': self.custom_user.pk}),
    ...
    def test_user_is_not_really_deleted(self):
        ...
        response = self.client.delete(reverse_lazy('users:user-detail', kwargs={'pk': self.custom_user.pk}))
    ...
    def test_list_inactive_users(self):
        ...
        response = self.client.get(reverse_lazy('users:user-inactive'))
